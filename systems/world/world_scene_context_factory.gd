...
const WorldSceneOperationHelpersClass = preload("res://systems/world/world_scene_operation_helpers.gd")

var operation_helpers = WorldSceneOperationHelpersClass.new()
...
func build_ready_context(scene) -> Dictionary:
	return {
		...
		"equip_backpack_item": func(item_definition, log_prefix): return operation_helpers.equip_backpack_item(scene, item_definition, log_prefix),
		"generate_rooms": func(): operation_helpers.generate_rooms(scene),
		...
		"set_build_mode": func(next_build_mode): operation_helpers.set_build_mode(scene, next_build_mode),
		"set_current_room": func(room_index): operation_helpers.set_current_room(scene, room_index),
		...
		"spawn_initial_backpack_world_item": func(): operation_helpers.spawn_initial_backpack_world_item(scene),
		...
		"update_player_follow_target": func(): operation_helpers.update_player_follow_target(scene),
...
func build_process_context(scene) -> Dictionary:
	return {
		...
		"check_void_fall": func(): return operation_helpers.check_void_fall(scene),
		...
		"get_room_world_rect": func(): return scene.world_query_facade.get_room_world_rect(scene.map_handler),
		"get_target_world_position": func(): return operation_helpers.get_target_world_position(scene),
		...
		"try_transition_room": func(): return operation_helpers.try_transition_room(scene),
		"update_active_atlas_worker_grounding": func(): operation_helpers.update_active_atlas_worker_grounding(scene),
		"update_mining": func(delta): return operation_helpers.update_mining(scene, delta),
		"update_player": func(delta): return operation_helpers.update_player(scene, delta),
		"update_player_follow_target": func(): operation_helpers.update_player_follow_target(scene),
...
func build_input_context(scene) -> Dictionary:
	return {
		...
		"clear_build_mode": func(): operation_helpers.clear_build_mode(scene),
		...
		"refresh_godmode_ui": Callable(scene.godmode_ui_controller, "refresh_godmode_ui"),
		"should_show_place_cursor": func(): return operation_helpers.should_show_place_cursor(scene),
		"toggle_console": Callable(scene.godmode_ui_controller, "toggle_console"),
		"try_place_preview_cells": func(): return operation_helpers.try_place_preview_cells(scene),
	}
...
func build_draw_context(scene) -> Dictionary:
	...
	return {
		...
		"can_place_any_preview_cells": func(ordered_preview_cells): return scene.world_build_mining_facade.can_place_any_preview_cells(scene.mining_runtime, {
			...
			"player_contains_cell": func(cell_position): return operation_helpers.player_contains_cell(scene, cell_position),
		...
		"can_place_cell": func(cell_position): return operation_helpers.can_place_cell(scene, cell_position),
		...
		"get_gravity_field_preview_rect": func(_ordered_preview_cells): return operation_helpers.get_gravity_field_preview_rect(scene),
		...
		"get_ordered_preview_cells": func(): return operation_helpers.get_ordered_preview_cells(scene),
		"get_selected_material_color": Callable(scene.inventory_runtime, "get_selected_material_color"),
		"get_shape_name": func(shape_type): return scene.world_build_mining_facade.get_shape_name(scene.mining_runtime, shape_type),
		"get_traversal_index": func(cell_position): return operation_helpers.get_traversal_index(scene, cell_position),
		...
		"inventory_data": scene.inventory_data,
		"is_mining_target_in_range": func(): return scene.world_build_mining_facade.is_mining_target_in_range(scene.mining_runtime, player_center_world, operation_helpers.get_cell_center_world(scene, scene.mining_center_cell)),
		...
		"room_transition_edge": operation_helpers.get_room_transition_edge(scene),
		"selected_material_id": scene.inventory_runtime.selected_material_id,
